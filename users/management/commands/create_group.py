...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        if created:
            ...
            course_view_permission = Permission.objects.get(
            ...
            lesson_view_permission = Permission.objects.get(
            ...
            moderators_group.permissions.add(
                ...
                lesson_view_permission,
                lesson_change_permission
            )
            ...
            self.stdout.write(
                self.style.WARNING('Группа "moderators" уже существует')
            )
